...
| 平台 | 文件（v0.3.0） | 适用 |
|------|---------------|------|
| 🍎 macOS · Apple Silicon | `LocalFlow AI-0.3.0-macOS-arm64.dmg` | M1/M2/M3/M4 等新 Mac |
| 🍎 macOS · Intel | `LocalFlow AI-0.3.0-macOS-x64.dmg` | Intel 芯片 Mac |
| 🪟 Windows | `LocalFlow AI-Setup-0.3.0-Windows-x64.exe` | Windows 10/11 64 位 |
| 🐧 Linux | `LocalFlow AI-0.3.0-Linux-x64.AppImage` | 主流 x86_64 发行版 |

> 💡 v0.2.0 起文件名已直接带平台标识（如 `LocalFlow AI-0.3.0-macOS-arm64.dmg`），按上表对应下载即可。
