...
MODEL_LIBRARY = [
    ...
    {"id": "qwen3:30b-a3b-instruct", "name": "Qwen3-30B-A3B-Instruct", "vram_gb": 21, "quant": "Q4_K_M",
     "desc": "Qwen3 MoE 大模型，中文与推理强，需 20GB+ 内存"},
    {"id": "qwen3:14b", "name": "Qwen3-14B", "vram_gb": 9.3, "quant": "Q4_K_M",
     "desc": "Qwen3 14B，中文与通用均衡，需 9GB+ 内存"},
    {"id": "qwen3:8b", "name": "Qwen3-8B", "vram_gb": 5.4, "quant": "Q4_K_M",
     "desc": "Qwen3 8B，轻量通用，显存友好"},
    {"id": "qwen3:4b", "name": "Qwen3-4B", "vram_gb": 2.9, "quant": "Q4_K_M",
     "desc": "Qwen3 4B，轻量快速，适合中端设备"},
    {"id": "qwen3:1.7b", "name": "Qwen3-1.7B", "vram_gb": 1.3, "quant": "Q4_K_M",
     "desc": "Qwen3 1.7B，极轻量，纯 CPU 也能跑"},
    {"id": "qwen3:235b-a22b-instruct", "name": "Qwen3-235B-A22B-Instruct", "vram_gb": 130, "quant": "Q4_K_M",
     "desc": "Qwen3 旗舰 MoE，需 128GB+ 内存，本机多半跑不动"},
